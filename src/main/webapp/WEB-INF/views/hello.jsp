                            ...
                            <div class="col-12">
                                <nav class="main-nav">
                                    ...
                                    <ul class="nav">
                                        ...
                                        <li><a href="login">Phòng Trọ</a></li>
                                        <li><a href="properties">Nhà, Căn Hộ Cho Thuê</a></li>
                                        <li><a href="property-details.html">Tìm Ở Ghép</a></li>
                                        <li><a href="postservice">Đăng Tin</a></li>
                                            ...
                                            <form method="get" action="bantin.php">
                                                <div class="col-md-12 mb-2 d-flex justify-content-center">
                                                    <div class="col-md-2 mb-2">
                                                        <select class="form-control" name="Tin_diachi" id="Tin_diachi"
                                                            required>
                                                    ...
                                                    <div class="col-md-2 mb-1">
                                                        <select class="form-control" name="Tin_hinhthuc"
                                                            ...
                                                            <option value="Trọ trong nhà chung chủ">Trọ trong nhà chung
                                                                chủ</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-2 mb-2">
                        ...
                        <div class="row">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-3">
                                                                    ...
                                                                    <p>Lorem ipsum dolor sit amet, consectetur
                                                                        adipiscing elit, do
                                                                        eiusmod
                                                                        tempor pack incididunt ut labore et dolore magna
                                                                        aliqua
                                                                        quised ipsum
                                                                        suspendisse.
                                                                        <br><br>When you need free CSS templates, you
                                                                        can simply
                                                                        type TemplateMo
                                                                        in any search engine website. In addition, you
                                                                        can type
                                                                        TemplateMo
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-3">
                                                                    ...
                                                                    <p>Lorem ipsum dolor sit amet, consectetur
                                                                        ...
                                                                        aliqua
                                                                        quised ipsum
                                                                        suspendisse. <br><br>Swag fanny pack lyft blog
                                                                        twee. JOMO
                                                                        ethical copper
                            ...
                            <div class="properties section">
                                <div class="container">
                                    ...
                                    <div class="row">
                                        <div th:each="listnewsletter : ${newsletter}" class="col-lg-4 col-md-6">
                                            <div class="item">
                                                <a href="property-details.html"><img src="assets/images/property-01.jpg"
                                                        alt=""></a>
                                                <span th:text="${listnewsletter.Address}" class="category">Thừa Thiên
                                                    Huế</span>
                                                <h6>
                                                    <th:block th:text="${listnewsletter.Price}"></th:block> VND
                                                </h6>
                                                <h4 th:text="${listnewsletter.NewsletterName}"><a
                                                        href="property-details.html">18
                                                        New Street
                                                        Miami, OR 97219</a></h4>
                                                <ul>
                ...
                <div class="contact-content">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-lg-5">
                                <form id="contact-form" action="#" th:action="@{/feedback/add}" method="post"
                                    th:object="${fb}">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <fieldset>
                                                <label for="name">Họ Và Tên</label>
                                                <input type="text" th:field="*{FullName}" placeholder="Tên của bạn..."
                                        ...
                                        <div class="col-lg-12">
                                            <fieldset>
                                                ...
                                                <input type="text" th:field="*{Email}" pattern="[^ @]*@[^ @]*"
                                        ...
                                        <div class="col-lg-12">
                                            <fieldset>
                                                ...
                                                <input type="text" th:field="*{Title}" placeholder="Subject..."
                                                    autocomplete="on">
                                            </fieldset>
                                        </div>
                                        <div class="col-lg-12">
                                            <fieldset>
                                                ...
                                                <textarea th:field="*{Context}" placeholder="Your Message"></textarea>
                                            </fieldset>
                                        </div>
                                        <div class="col-lg-12">
                                            <fieldset>
