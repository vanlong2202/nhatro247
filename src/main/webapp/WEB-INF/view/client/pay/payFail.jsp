                        ...
                        <div class="body-pay">
                            <div class="pay-notication">
                                <div style="margin-bottom: 20px;" class="row"><span><i
                                            class="fa-solid fa-circle-xmark fa-2xl" style="color: #ff0000;"></i></span>
                                </div>
                                <span>GIAO DỊCH THẤT BẠI!</span>
                                <p>Giao dịch không thành công, khách hàng hủy giao dịch</p>
                            </div>
                            <div class="pay-info">
                                ...
                                <div class="pay-button">
                                    <a href="/deposit" class="btn btn-primary">Quay về</a>
