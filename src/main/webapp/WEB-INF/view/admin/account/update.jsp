                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form:form action="/admin/update-submit" modelAttribute="info" method="post"
                                            class="row g-3">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <form:input path="facebook" type="text" class="form-control"
                                                    placeholder="Nhập link facebook dưới dạng url ..." />
                                            </div>
                                            <div class="text-center">
                                                <button type="submit" class="btn btn-primary">Cập Nhật</button>
                                                <button onclick="history.back()" type="reset"
                                                    class="btn btn-secondary">Trờ lại</button>
                                            </div>
                                        </form:form>
                                    </div>
                                </div>
