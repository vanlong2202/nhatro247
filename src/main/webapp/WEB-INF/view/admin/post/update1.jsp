                                ...
                                <div class="card-body">
                                    <form:form action="/admin/post/update-submit" method="post" modelAttribute="blog"
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <form:input style="display: none;" path="postID" id="postID"
                                                    type="text" />
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <form:select id="postType" path="postType" class="form-select"
                                        ...
                                        <div class="row mb-3">
                                            <label for="inputEmail" class="col-sm-2 col-form-label">Nội Dung Bài
                                                Viết</label>
                                            <div class="col-sm-10">
                                                <form:textarea id="content" path="content" class="tinymce-editor" />
                                            </div>
                                        </div>
                                        <div class="row mb-3">
