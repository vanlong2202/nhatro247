                ...
                <body>
                    ...
                    <main id="main" class="main">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form:form action="/admin/add-post" method="post" modelAttribute="post"
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <form:select path="postType" class="form-select"
                                                    aria-label="Default select example">
                                                    <c:forEach var="postType" items="${type}">
                                                        <option value="${postType.postTypeID}">${postType.name}</option>
                                                    </c:forEach>
                                                </form:select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <img id="previewImage" alt="Preview Image"
                                                    style="max-width: 400px; height: 250px; object-fit: cover; display: none;margin-top: 10px;">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
